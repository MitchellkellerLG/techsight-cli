...
CATEGORIES: dict[int, str] = {
    ...
    59: "Retargeting",
    60: "RUM",
    61: "Cookie compliance",
    62: "Loyalty/rewards",
    63: "Feature management",
    64: "Segmentation",
    65: "Booking/reservations",
    66: "Surveys",
    67: "DMP",
    68: "Chat",
    69: "Cart functionality",
    70: "Cart abandonment",
    71: "Customer data platform",
    72: "Consent management",
    73: "Performance",
    74: "ID management",
    75: "Geolocation",
    76: "Affiliate",
    77: "Appointment scheduling",
    78: "Recruitment/staffing",
    79: "User onboarding",
    80: "Reviews",
    81: "Buy now pay later",
    82: "Form builder",
    83: "CIAM",
    84: "Live chat",
    85: "Translation",
    86: "Shipping",
    87: "Customer success",
    88: "Referral marketing",
    89: "Digital asset management",
    90: "Content curation",
    91: "Domain parking",
    92: "Fundraising/donations",
    93: "Cross-border ecommerce",
    94: "Fulfilment",
    95: "Product recommendations",
    96: "Visual search",
    97: "Customer data platform",
    98: "PIM",
    99: "Digital experience platform",
    100: "Session replay",
    101: "Hosting",
    102: "Data governance",
    103: "Tariff/duty/tax",
    104: "Web accessibility",
    105: "Headless CMS",
}
        ...
        "technologies": [
            {
                "name": d.name,
                "group": _NAME_TO_GROUP.get(d.name)
                or next((_CAT_TO_GROUP[c] for c in d.category_ids if c in _CAT_TO_GROUP), "other"),
